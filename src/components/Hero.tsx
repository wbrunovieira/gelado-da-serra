...
export function Hero() {
  ...
  useGSAP(
    () => {
      ...
      tl.from(".hero-line > span", { yPercent: 110, duration: 1.1, stagger: 0.09 }, 0.1)
        ...
        .from(".hero-sun", { yPercent: 120, opacity: 0, duration: 1.6, ease: "power3.out" }, 0.2)
  ...
  return (
    ...
    >
      <Sun
        className="hero-sun pointer-events-none absolute right-[6%] top-[43%] -z-10 h-20 w-20 md:right-[3%] md:top-[8%] md:h-48 md:w-48"
        style={{ filter: "drop-shadow(0 0 40px rgba(254,221,14,0.45)) drop-shadow(0 0 120px rgba(240,168,58,0.35))" }}
      />
      <MountainRange
        className="hero-mountains pointer-events-none absolute -bottom-10 left-[-25%] -z-10 w-[150%] opacity-80 md:-bottom-24 md:left-[-5%] md:w-[110%]"
        style={{ ["--mtn-fill" as string]: "#0d3164", ["--snow-fill" as string]: "#2a63ac" }}
      />
